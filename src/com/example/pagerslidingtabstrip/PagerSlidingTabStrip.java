...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
		...
		maxLineWidth = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pstsMaxLineWidth, 0);
		tabTextSize = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_tabTextSize, dp2px(context,16));
		underlineMarginTop = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_underlineMarginTop, underlineMarginTop);
		a.recycle();
